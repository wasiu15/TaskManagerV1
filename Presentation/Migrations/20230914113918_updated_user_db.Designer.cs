...
namespace TaskManager.Presentation.Migrations
{
    ...
    [Migration("20230914113918_updated_user_db")]
    partial class updated_user_db
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Models.UserTask", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TaskId = new Guid("7c174ad0-ce3b-4da6-8454-1909767c8118"),
                        ...
                        new
                        {
                            TaskId = new Guid("ee72dc93-7b8a-44a3-8cf5-b1fd1788605c"),
